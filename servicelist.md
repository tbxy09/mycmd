...
SERVICE_NAME: BaiduYunUtility
DISPLAY_NAME: BaiduYunUtility
SERVICE_NAME: BDESVC
...
SERVICE_NAME: cphs
DISPLAY_NAME: Intel(R) Content Protection HECI Service
...
SERVICE_NAME: DongFangIMEV2
DISPLAY_NAME: DongFangIMEService
...
DISPLAY_NAME: Google 更新服务 (gupdatem)
...
DISPLAY_NAME: Internet Explorer ETW Collector Service
...
SERVICE_NAME: SogouUpdate
DISPLAY_NAME: SogouUpdate
...
DISPLAY_NAME: SogouDownLoad Update Service
...
SERVICE_NAME: VsEtwService120
DISPLAY_NAME: Visual Studio ETW Event Collection Service
SERVICE_NAME: VSS
